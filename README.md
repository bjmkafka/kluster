...
The default cluster has a standalone Zookeeper, three kafka brokers, a variety of Confluent Platform 7.0.1 components in a single cluster. Use commandline arguments to override the defaults:
...
Options:
  ...
  -v <version> Confluent Platform version (default: 7.0.1)
